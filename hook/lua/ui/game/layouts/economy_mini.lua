...
function LayoutResourceGroup(group, groupType)
    ...
    LayoutHelpers.RightOf(group.rate, group.storageBar, 0)
    LayoutHelpers.AtVerticalCenterIn(group.rate, group)

    --LayoutHelpers.RightOf(group.overflow, group.rate, 2)
    LayoutHelpers.AtLeftIn(group.overflow, group.rate, 60)
    --LayoutHelpers.RightOf(group.overflow, group.rate,)
    --group.overfl ow.Left:Set(function() return group.rate.Left()+40 end)
